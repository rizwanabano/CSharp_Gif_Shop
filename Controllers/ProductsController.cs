...
namespace ShoppingCart.Controllers
{
        ...
        //[HttpGet] 
        //public async Task<IActionResult>  SearchBar(string ProductName)
        //{
        //    ViewData["GetProductDetails"] = ProductName;
        //    var projectquery = from x in _context.Products select x;
        //    if(!String.IsNullOrEmpty(ProductName))
        //    {
        //        projectquery=projectquery.Where(x=>x.Name.Contains(ProductName));
        //    }
